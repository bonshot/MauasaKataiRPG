...
INSERT INTO `classes`(name, description, extra_vigor, extra_strength, extra_dexterity, extra_intelligence, extra_faith, extra_luck, extra_concentration) VALUES
('Warrior', 'A strong, sturdy and reckless fighter that only cares about battle.', 5, 5, 2, 1, 1, 1, 0),
('Rogue', 'A sneaky and agile assassin that strikes when no one is watching.', 2, 2, 5, 1, 1, 5, 2),
('Mage', 'A scholar of stars and elements devoted by the knowledge acquired by the years.', 1, 1, 1, 5, 5, 2, 5),
('Cleric', 'An agile fighter well known for its versatility and a bit of knowledge of everything.', 2, 2, 1, 1, 5, 5, 3),
('Paladin', 'A warrior with fortitude devoted by its faith.', 5, 5, 1, 2, 2, 2, 4),
('Bard', 'An agile fighter, with a little knowledge of supportive magic, and an excelent musician.', 2, 1, 5, 2, 2, 5, 3),
('Priest', 'A fully devote by its faith, it depends of its conviction.', 2, 2, 2, 2, 2, 5, 5),
('Warlock', 'A scholar of dark arts, reckless with the use of the health points.', 1, 1, 1, 5, 5, 2, 5),
('Ranger', 'A scholar of nature and an agile fighter.', 2, 2, 2, 5, 2, 2, 1);
